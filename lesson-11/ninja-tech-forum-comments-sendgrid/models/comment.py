...
class Comment(Model):
    ...
    def insert(self):
        ...
        author = User.get_by_username(username=self.author_username)
        ...
        if sender_email and api_key and author.email_address:
            ...
            data = {"personalizations": [{
                    ...
                    "content": [{
                        "type": "text/plain",
                        "value": "A new comment was posted in your topic"  # if we'd saved topic title in comment object, we'd easily add it in the email message
                    }]
            }
